...
func TestBasicRunner(t *testing.T) {
	...
	var runner = runner.NewRunner("test", runner.NoValidator, runner.NoExecutor)
...
func TestInvalidRunner(t *testing.T) {
	...
	var runner = runner.NewRunner("name", func(context *runner.Context) error {
...
func TestErrorRunner(t *testing.T) {
	...
	var runner = runner.NewRunner("information", runner.NoValidator, func(context *runner.Context) error {
		return errors.New("error message")
	})
	assertion.NewName("get result information").
...
func TestDisableRunner(t *testing.T) {
	...
	var counter = 0
	var before = runner.NewRunner("message", func(context *runner.Context) error {
		counter++
		return nil
	}, func(context *runner.Context) error {
		counter++
		return nil
	})
	assertion.NewName("get result information").
	...
	counter = 0
	var inValidate = runner.NewRunner("validate", func(context *runner.Context) error {
